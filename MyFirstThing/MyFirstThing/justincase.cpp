...
void Meals()
{
	...
	while (thing == 0)
	{
		/*while (thing5 == 0)
		{
			...
			cout << "Do You Want to Enter Person Names?" << endl;
		...
		//if (nYes == "Yes" || nYes == "Yes" || nYes == "Yes" || nYes == "Yes")
		//{

			Next2();

			cout << "Enter Person " << (PersonNumber+1) << "'s Name Here" << endl;
	...
	/*	if (nYes == "No" || nYes == "no" || nYes == "N" || nYes == "n" || thing == 0)
		{
		...
		cout << "Money" << PersonMoney << "Tax" << sReal << endl;
		sReal /= 100;
